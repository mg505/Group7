...
public class RefundTicketUI {
    ...
    public void createRefundTicketUI() {
                ...
                if (selectedTicket != null) {
                    ...
                    if (success) {
                        ...
                        if (ticketDropdown.getItemCount() == 0) {
                            refundButton.setEnabled(false); // Disable button if no tickets are left
                        }
                    } else {
        ...
        backButton.addActionListener(e -> {
            ...
            new DashboardUI(loggedInUser, loginSystem);  // Open the DashboardUI with LoginSystem reference
        });
